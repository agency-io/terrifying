# title: ecs-containers-readonly-access
# description: Detects ECS task definitions where any container lacks a read-only root filesystem. Equivalent to AWS Config ecs-containers-readonly-access. Maps to FSBP ECS.5 (High).
# severity: High
