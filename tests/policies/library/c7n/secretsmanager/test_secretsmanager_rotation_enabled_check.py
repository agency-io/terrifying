...
POLICY = Path(__file__).parent.parent.parent.parent.parent.parent / "terrifying/policies/library/secretsmanager/secretsmanager-rotation-enabled-check.yml"
...
def test_violation_rotation_resource_exists():
    ...
    tf = tf_resource(
        "aws_secretsmanager_secret_rotation", "rotation",
