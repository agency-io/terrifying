...
RUNTIME_ONLY = {
    "ec2-stopped-instance", "ec2-volume-inuse-check", "eip-attached",
    "ebs-snapshot-public-restorable-check", "dynamodb-in-backup-plan",
    "efs-in-backup-plan", "vpc-network-acl-unused-check", "access-keys-rotated",
    "iam-user-mfa-enabled", "iam-user-unused-credentials-check",
    "mfa-enabled-for-iam-console-access", "kms-cmk-not-scheduled-for-deletion-2",
